...
from cuprate.sectors import comb_safe, compute_all_sector_counts
...
def analyze_space(N: int) -> None:
    ...
    results = compute_all_sector_counts(N, print_out=False)
    ...
    for entry in results:
        for twoS, S2_val, dim_sz_s in entry["S2_counts"]:
            ...
            print(f"  twoSz={entry['twoSz']}, twoS={twoS}, S2={S2_val:.2f}: dim={dim_sz_s}, dim_eff={dim_eff_sz_s}")
